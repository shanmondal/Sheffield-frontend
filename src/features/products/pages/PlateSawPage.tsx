        ...
        <div className="grid gap-10 lg:grid-cols-2 items-center">
          ...
          <div>
            ...
            <p className="leading-relaxed text-lg text-slate-600">
              Manufactured to high quality standards for agricultural
              machinery, ripping and occasional crosscutting applications.
            </p>

            <p className="mt-5 leading-relaxed text-slate-600">
              Made from chrome vanadium steel and carefully tensioned
              to ensure optimum cutting performance and long service life.
            </p>
          </div>
      ...
      <section className="border-t py-16">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mb-8 text-lg text-slate-600">
            Contact our engineering team for sizing, blade specifications
            and recommendations.
          </p>
